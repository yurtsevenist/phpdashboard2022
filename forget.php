        ...
        <div class="row">
            ...
            <section class="yüzvh">
                <div class="col-md-6 offset-md-3">
                    <form action="php/unuttum.php" method="post" class="box">
                        <h1 class="title">ŞİFREMİ UNUTTUM</h1>
                        <input type="email" name="email" required placeholder="E-Posta Adresinizi giriniz">
                        <input type="submit" name="" value="E-Posta Gönder">
                        <p><a href="login.php"><code>Giriş...</code></a></p>
